...
function resetPositions() {
    ...
    // Reset posisi hantu
    ghosts[0] = { name: 'blinky', x: 15, y: 7, direction: 'left', color: '#FF1744' };
    ghosts[1] = { name: 'pinky', x: 15, y: 9, direction: 'up', color: '#FF4081' };
    ghosts[2] = { name: 'inky', x: 14, y: 9, direction: 'down', color: '#00E5FF' };
    ghosts[3] = { name: 'clyde', x: 16, y: 9, direction: 'right', color: '#FF9100' };
